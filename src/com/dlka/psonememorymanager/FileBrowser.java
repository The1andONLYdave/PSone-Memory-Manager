<<<<<<< HEAD:src/com/dlka/psonememorymanager/FileBrowser.java
...
public class FileBrowser extends ListActivity {
        ...
        private void browseTo(final File aDirectory){
                if (aDirectory.isDirectory()){
                	...
                	if(!dirpick){
	                	Intent i = new Intent();
	                	String fn = new String(aDirectory.getAbsolutePath());
	                	i.putExtra("com.topherlee.psonememorymanager.FN", fn);
	                	//startActivity(i);
	                	setResult(RESULT_OK, i);                	
	                	finish();
                	}
        ...
        protected void onListItemLongClick(ListView l, View v, int position, long id){
            ...
            if(!selectedFileString.equals("..")&&!selectedFileString.equals(".")){
                ...
                if(clickedFile!=null&&clickedFile.isDirectory()){
                	fn = clickedFile.getAbsolutePath();
                	Intent i = new Intent().putExtra("com.topherlee.psonememorymanager.FN", fn);
                	i.putExtra("savenum", savenum);
                	//startActivity(i);
                	setResult(RESULT_OK, i);                	
                	finish();
...
>>>>>>> TopherLee513/master:src/com/topherlee/psonememorymanager/FileBrowser.java
