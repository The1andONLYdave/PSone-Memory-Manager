<<<<<<< HEAD:src/com/dlka/psonememorymanager/MCViewActivity.java
...
public class MCViewActivity extends ListActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		fn = intent.getStringExtra("com.dlka.psonememorymanager.FN");		
        ...
        filter.addAction("com.dlka.psonememorymanager.COPYMC");
	...
	public void sendBroadcast(int num){
		...
		broadcast.setAction("com.dlka.psonememorymanager.COPYMC");
		MemoryCard mcl = Statics.cards[testid];
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
            final int selectionRowID = position;
...
>>>>>>> TopherLee513/master:src/com/topherlee/psonememorymanager/MCViewActivity.java
